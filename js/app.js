...
const DAYS = [
  {
    ...
    exercises: [
      ex('bankdruecken-lh', 'Bankdrücken (LH)', '4×8/5/8/5/8', {
        36: ['40×8'], 37: ['67,5×8', '30kg KH×8'], 38: ['75×5', '77,5×5'], 39: ['70×8'], 40: ['82,5×5'], 41: ['72,5×8'], 42: ['47,5×8']
      }),
      ex('kh-kickbacks', 'KH Kickbacks', '3×12', {
        36: ['8×12'], 37: ['12×12', 'ok'], 38: ['14×12', 'ok'], 39: ['13×12'], 40: ['15×12'], 41: ['13×12'], 42: ['8×12']
      }),
      ex('schraegbank-kh', 'Schrägbank (KH)', '3×8/5/8/5/8', {
        36: ['16×8'], 37: ['27×8', '26×7'], 38: ['28×5', '30×5'], 39: ['26×8'], 40: ['32×5'], 41: ['28×8'], 42: ['18×8']
      }),
      ex('trizeps-overhead-extension-kh', 'Trizeps Overhead Extension (KH)', '3×12', {
        36: ['10×12'], 37: ['14×12'], 38: ['16×12', '22×12'], 39: ['20×12'], 40: ['24×12'], 41: ['22×12'], 42: ['12×12']
      }),
      ex('dips', 'Dips', '3×8/5/8/5/8', {
        36: ['KG×8'], 37: ['KG×8', 'ok'], 38: ['+15kg×5', 'ok'], 39: ['KG×8'], 40: ['+20kg×5'], 41: ['KG×8'], 42: ['KG×5']
      }),
      ex('kh-flys', 'KH Flys', '3×12', {
        36: ['8×12'], 37: ['12×12', 'ok'], 38: ['14×12', 'ok'], 39: ['13×12'], 40: ['15×12'], 41: ['13×12'], 42: ['8×12']
      }),
      ex('plank', 'Plank', '3×—', {
        36: ['30 Sek'], 37: ['55 Sek', 'ok'], 38: ['60 Sek', 'ok'], 39: ['55 Sek'], 40: ['65 Sek'], 41: ['60 Sek'], 42: ['40 Sek']
      }),
      ex('beinheben', 'Beinheben', '3×15', {
        36: ['10 Wdh'], 37: ['15 Wdh', 'ok'], 38: ['15 Wdh', 'ok'], 39: ['15 Wdh'], 40: ['15 Wdh'], 41: ['15 Wdh'], 42: ['10 Wdh']
      })
    ]
  },
  {
    ...
    exercises: [
      ex('kreuzheben', 'Kreuzheben (LH)', '4×8/5/8/5/8', {
        36: ['45×8'], 37: ['77,5×8', '80×8'], 38: ['85×5', '90×5'], 39: ['82,5×8'], 40: ['95×5'], 41: ['87,5×8'], 42: ['55×8']
      }),
      ex('latzug-weit', 'Latzug (weit)', '4×8/5/8/5/8', {
        36: ['40×8'], 37: ['72,5×8', '75×8'], 38: ['82,5×5', '85×5'], 39: ['77,5×8'], 40: ['90×5'], 41: ['82,5×8'], 42: ['50×8']
      }),
      ex('bizeps-curl-sz', 'Bizeps Curl (SZ)', '3×8/5/8/5/8', {
        36: ['37,5×8'], 37: ['60×8', 'ok'], 38: ['70×5', '75×5'], 39: ['67,5×8'], 40: ['80×5'], 41: ['72,5×8'], 42: ['45×8']
      }),
      ex('preacher-curl-kh', 'Preacher Curl (KH)', '3×12', {
        36: ['10×12'], 37: [''], 38: [''], 39: ['14×12'], 40: ['16×12'], 41: ['14×12'], 42: ['10×12']
      }),
      ex('hammer-curl', 'Hammer Curl (KH)', '3×12', {
        36: ['10×12'], 37: ['16×12', 'ok'], 38: ['18×12', 'ok'], 39: ['16×12'], 40: ['18×12'], 41: ['17×12'], 42: ['10×12']
      }),
      ex('kh-rudern-einarmig', 'KH Rudern einarmig', '3×8/5/8/5/8', {
        36: ['12×8'], 37: ['20×8', '26×8'], 38: ['30×5', '34×5'], 39: ['30×8'], 40: ['37,5×5'], 41: ['32,5×8'], 42: ['16×8']
      }),
      ex('reverse-flys', 'Reverse Flys (KH)', '2×12', {
        36: ['6×12'], 37: ['10×12', 'ok'], 38: ['12×12', 'ok'], 39: ['11×12'], 40: ['13×12'], 41: ['11×12'], 42: ['7×12']
      }),
      ex('crunches-kabel', 'Crunches (Kabel)', '3×15', {
        36: ['37,5×15'], 37: ['60×15', 'ok'], 38: ['70×15', '70×10'], 39: ['65×15'], 40: ['70×15'], 41: ['67,5×15'], 42: ['40×15']
      })
    ]
  },
  {
    ...
    exercises: [
      ex('kniebeugen-lh', 'Kniebeugen (LH)', '4×8/5/8/5/8', {
        36: ['35×8'], 37: ['55×8', '60×8'], 38: ['70×5', '72,5×5'], 39: ['65×8'], 40: ['77,5×5'], 41: ['67,5×8'], 42: ['40×8']
      }),
      ex('seitheben-kh', 'Seitheben (KH)', '2×12', {
        36: ['8×12'], 37: ['12×12', 'ok'], 38: ['14×12', 'ok'], 39: ['12×12'], 40: ['14×12'], 41: ['12×12'], 42: ['8×12']
      }),
      ex('rum-kreuzheben-lh', 'Rum. Kreuzheben (LH)', '3×8/5/8/5/8', {
        36: ['37,5×8'], 37: ['60×8', 'ok'], 38: ['70×5', 'ok'], 39: ['62,5×8'], 40: ['75×5'], 41: ['65×8'], 42: ['42,5×8']
      }),
      ex('kh-schulterdruecken', 'KH Schulterdrücken', '4×8/5/8/5/8', {
        36: ['12×8'], 37: ['18×8', '22×8'], 38: ['26×5', 'ok'], 39: ['24×8'], 40: ['28×5'], 41: ['25×8'], 42: ['15×8']
      }),
      ex('beinbeuger', 'Beinbeuger sitzend', '3×8/5/8/5/8', {
        36: ['30×8'], 37: ['50×8', '25×8'], 38: ['30×5', '35×5'], 39: ['32,5×8'], 40: ['40×5'], 41: ['35×8'], 42: ['20×8']
      }),
      ex('frontheben-kh', 'Frontheben (KH)', '2×12', {
        36: ['6×12'], 37: ['10×12', 'ok'], 38: ['12×12', 'ok'], 39: ['10×12'], 40: ['12×12'], 41: ['11×12'], 42: ['7×12']
      }),
      ex('hip-thrust-lh', 'Hip Thrust (LH)', '3×8/5/8/5/8', {
        36: ['37,5×8'], 37: ['60×8', 'ok'], 38: ['70×5', 'ok'], 39: ['62,5×8'], 40: ['75×5'], 41: ['65×8'], 42: ['42,5×8']
      }),
      ex('ausfallschritte', 'Ausfallschritte (KH)', '3×10/Seite', {
        36: ['8×10'], 37: ['12×10', '12×8'], 38: ['12×10', 'ok'], 39: ['12×10'], 40: ['14×10'], 41: ['13×10'], 42: ['8×10']
      }),
      ex('wadenheben', 'Wadenheben', '3×15', {
        36: ['22,5×15'], 37: ['35×15', 'ok'], 38: ['40×15', 'ok'], 39: ['37,5×15'], 40: ['42,5×15'], 41: ['40×15'], 42: ['25×15']
      }),
      ex('nacken-kh', 'Nacken KH', '2×12', {
        36: ['20×12'], 37: ['30×12', 'ok'], 38: ['34×12', '34×10'], 39: ['30×12'], 40: ['34×12'], 41: ['32×12'], 42: ['20×12']
      })
    ]
  }
];
