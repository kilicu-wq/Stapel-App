...
const DAYS = [
  {
    ...
    exercises: [
      ex('bankdruecken-lh', 'Bankdrücken (LH)', '4×8/5/8/5/8', '55×8', 'ok', '65×5', '70×5', '62,5×8', '', '72,5×5', '75×5', '67,5×8', ''),
      ex('schraegbank-kh', 'Schrägbank (KH)', '3×8/5/8/5/8', '20×8', 'ok', '24×5', '28×5', '24×8', '', '30×5', 'ok (30×5)', '26×8', ''),
      ex('dips', 'Dips', '3×8/5/8/5/8', 'KG×8', 'ok', '+5kg×5', '+10kg×5', 'KG×8', '', '+12,5kg×5', '+15kg×5', 'KG×8', ''),
      ex('trizeps-pushdown', 'Trizeps Pushdown', '3×12', '20×12', 'ok', '25×12', 'ok(ish)', '22,5×12', '', '27,5×12', '25×12', '25×12', ''),
      ex('kh-flys', 'KH Flys', '3×12', '10×12', '10×12', '12×12', '14×10', '12×12', '', '14×12', 'ok (14×12)', '13×12', ''),
      ex('plank', 'Plank', '3×—', '45 Sek', 'ok', '50 Sek', 'ok', '50 Sek', '', '60 Sek', 'ok (60 Sek)', '55 Sek', ''),
      ex('beinheben', 'Beinheben', '3×12/15', '12 Wdh', 'ok', '12 Wdh', 'ok', '15 Wdh', '', '15 Wdh', 'ok', '15 Wdh', '')
    ]
  },
  {
    id: 'B', label: 'Pull', cardio: true,
    exercises: [
      ex('kreuzheben', 'Kreuzheben', '4×8/5/8/5/8', '65×8', 'ok', '75×5', 'ok', '70×8', '', '80×5', '85×5', '75×8', ''),
      ex('latzug-weit', 'Latzug (weit)', '4×8/5/8/5/8', '55×8', 'ok', '65×5', '70×5', '62,5×8', '', '72,5×5', '80×5', '70×8', ''),
      ex('kabelrow', 'Kabelrow', '3×8/5/8/5/8', '45×8', 'ok', '55×5', '70×5', '60×8', '', '72,5×5', '80×5', '65×8', ''),
      ex('bizeps-curl-sz', 'Bizeps Curl (SZ)', '3×8/5/8/5/8', '30×8', 'ok', '35×5', '60×5', '50×8', '', '62,5×5', '70×5', '57,5×8', ''),
      ex('hammer-curl', 'Hammer Curl', '3×12', '14×12', 'ok', '16×12', '', '14×12', '', '18×12', '', '16×12', ''),
      ex('reverse-flys', 'Reverse Flys', '2×12', '10×12', 'ok', '12×12', '', '10×12', '', '13×12', '14×10', '11×12', ''),
      ex('crunches-kabel', 'Crunches (Kabel)', '3×15', '50×15', 'ok', '65×15', '70×15', '60×15', '', '75×15', '75×10', '60×15', '')
    ]
  },
  {
    id: 'C', label: 'Schultern + Beine', cardio: true,
    exercises: [
      ex('beinpresse', 'Beinpresse', '4×8/5/8/5/8', '230×8', 'ok', '270×5', '290×5', '255×8', '', '305×5', '310×5', '270×8', ''),
      ex('schulterdruecken-lh', 'Schulterdrücken (LH)', '4×8/5/8/5/8', '20×8', '17,5×8', '25×5', 'ok', '20×8', '', '27,5×5', 'ok (27,5×5)', '22,5×8', ''),
      ex('beinbeuger', 'Beinbeuger', '3×8/5/8/5/8', '35×8', 'ok', '40×5', '50×5', '42,5×8', '', '52,5×5', '55×5', '45×8', ''),
      ex('seitheben-kh', 'Seitheben (KH)', '2×12', '10×12', 'ok', '12×12', '12×10', '10×12', '', '12×12', 'ok (12×12)', '12×12', ''),
      ex('ausfallschritte', 'Ausfallschritte', '3×10/Seite', '10×10', 'ok', '12×10', 'ok', '10×10', '', '14×10', 'ok (14×10)', '12×10', ''),
      ex('frontheben-kh', 'Frontheben (KH)', '2×12', '10×12', 'ok', '12×12', '12×10', '10×12', '', '14×12', '12×12', '12×12', ''),
      ex('wadenheben', 'Wadenheben', '3×15', '27,5×15', 'ok', '30×15', '35×15', '30×15', '', '37,5×15', '40×15', '37,5×15', ''),
      ex('nacken-kh', 'Nacken KH', '2×12', '26×12', 'ok', '28×12', '30×12', '28×12', '', '32×12', '34×12', '32×12', ''),
      ex('russian-twist', 'Russian Twist', '3×15/Seite', '8×15', 'ok', '10×15', '5×15', '6×15', '', '8×15', '10×15', '9×15', '')
    ]
  }
];
